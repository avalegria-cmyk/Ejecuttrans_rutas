...
<section class="logout-panel"><div><strong>Cerrar sesión</strong><p>Finaliza tu sesión de forma segura en este dispositivo.</p></div><a class="button logout-button" href="/auth/logout.php"><span aria-hidden="true">↪</span> Salir de la cuenta</a></section>
</div>
