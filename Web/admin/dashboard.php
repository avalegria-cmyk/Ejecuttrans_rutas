...
?>
<div class="overview-intro"><div><p class="eyebrow">RESUMEN GENERAL</p><h2>Así va la operación hoy</h2><p class="muted">Datos de <?= e(date('d/m/Y')) ?> · Hora de Ecuador</p></div><a class="button" href="<?= e(urlApp('Web/admin/recorridos.php')) ?>">Ver recorridos <span aria-hidden="true">→</span></a></div>
...
<div class="overview-grid">
  <section class="panel overview-activity"><div class="section-title"><div><span class="profile-label">ÚLTIMA ACTIVIDAD</span><h2>Recorridos recientes</h2></div><a href="<?= e(urlApp('Web/admin/recorridos.php')) ?>">Ver todos →</a></div>
